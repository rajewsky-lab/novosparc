...
htmlhelp_basename = 'novosparcdoc'
...
latex_documents = [
    (master_doc, 'novosparc.tex', 'novosparc Documentation',
     'Nikos Karaiskos, Mor Nitzan', 'manual'),
]
...
man_pages = [
    (master_doc, 'novosparc', 'novosparc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'novosparc', 'novosparc Documentation',
     author, 'novosparc', 'One line description of project.',
     'Miscellaneous'),
]
